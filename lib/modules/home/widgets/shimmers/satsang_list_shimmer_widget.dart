...
/// Shimmer placeholder that mirrors the satsang list card layout while it loads.
class SatsangListShimmerWidget extends StatelessWidget {
  /// Creates a [SatsangListShimmerWidget].
  const SatsangListShimmerWidget({super.key});
