...
/// Searchable dropdown for selecting a village during registration.
///
...
class VillageDropWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Selector<RegisterationProvider, List<VillageData>>(
        selector: (context, p) => p.villageResponse.data ?? [],
        builder: (context, value, child) => StreamBuilder(
          stream: context.registerationProvider.villageStream(),
          builder: (context, snapshot) {
            return DropdownSearch<VillageData>(
              selectedItem: snapshot.data,
              items: (filter, infiniteScrollProps) async =>
                  await context.registerationProvider.fetchVillageList(
                    filter,
                    context
              ...
              //   return true;
              // },
              onSelected: context.registerationProvider.changeVillage,
